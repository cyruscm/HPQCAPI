...
public class AuthenticateLoginLogoutExample {
	...
	public static void main(String[] args) throws Exception {
		...
		Assert.publishResults();
	}

	public void authenticateLoginLogoutExample(final String serverUrl, final String domain, final String project,
		...
		String SITE_SESSION = con.buildUrl("rest/site-session");

		Response response = con.httpPost(SITE_SESSION, null, new HashMap<String, String>());
		Assert.assertTrue("login did not cause creation of QCSession cookie.",
