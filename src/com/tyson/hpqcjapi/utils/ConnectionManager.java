...
public class ConnectionManager {
     ...
     * @throws Exception
     */
    public Response createEntity(String endpoint, String postedEntityXml) {
    	String collectionUrl = con.buildUrl(endpoint);
    	
    	Logger.logDebug("createEntity called on " + collectionUrl + " with xml:");
    	Logger.logDebug(postedEntityXml);
        ...
        try {
        response = con.httpPost(collectionUrl,
     ...
     * @throws Exception
     */
    public Response updateEntity(String endpoint, String postedEntityXml)
            throws Exception {
    	String collectionUrl = con.buildUrl(endpoint);
...
//        return entityUrl;
	...
	public Entity queryEntity(String endpoint, Map<String, String> queryParams) throws Exception { 
    	String collectionUrl = con.buildUrl(endpoint);
    	
        if (!isAuthenticated()) {
            Logger.logWarning("Not authenticated, exiting queryEntity(" + collectionUrl + ")");
            return null;
        }
		Map<String, String> requestHeaders = new HashMap<String, String>();
		requestHeaders.put("Accept", "application/xml");
		...
		return EntityMarshallingUtils.marshal(Entity.class, response);
	}

	public Entities queryCollection(String endpoint, Map<String, String> queryParams) throws Exception { 
    	String collectionUrl = con.buildUrl(endpoint);
