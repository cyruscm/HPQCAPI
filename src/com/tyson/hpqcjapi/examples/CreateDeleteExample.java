...
public class CreateDeleteExample {
    ...
    /**
     * @param collectionUrl   the url of the collection of the relevant entity type.
     * @param postedEntityXml the xml describing an instance of said entity type.
    ...
    /**
     * @param entityUrl the url of the entity that we wish to remove
