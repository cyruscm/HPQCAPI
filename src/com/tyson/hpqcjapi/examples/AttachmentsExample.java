...
public class AttachmentsExample {
    ...
    /**
     * @param entityUrl          the entity whose attachment we'd like to update
     * @param bytes              the data to write instead of previously stored data
     * @param attachmentFileName the attachment we'd like to update file name on the server side.
     * @return
     */
    ...
    /**
     * @param entityUrl          url of entity whose attachment's description we want to update
     * @param description        string to store as description
     * @param attachmentFileName the attachment file name on the server-side whose
    ...
    /**
     * @param attachmentUrl of attachment
